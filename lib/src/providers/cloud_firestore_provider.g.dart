...
@ProviderFor(routeFunctionsUrl)
final routeFunctionsUrlProvider = AutoDisposeProvider<String>.internal(
  routeFunctionsUrl,
  name: r'routeFunctionsUrlProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$routeFunctionsUrlHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef RouteFunctionsUrlRef = AutoDisposeProviderRef<String>;
