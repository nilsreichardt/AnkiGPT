...
part of 'has_account_provider.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$hasAccountHash() => r'913e7cdb6cea9231431e40b3f67fbe5f3b6a0d34';

/// See also [hasAccount].
@ProviderFor(hasAccount)
final hasAccountProvider = AutoDisposeStreamProvider<bool>.internal(
  hasAccount,
  name: r'hasAccountProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$hasAccountHash,
  dependencies: null,
